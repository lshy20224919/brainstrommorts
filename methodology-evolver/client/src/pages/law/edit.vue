<template>
  <view class="page-edit-law">
    <!-- 标题 -->
    <view class="page-header">
      <text class="page-title">编辑规律</text>
    </view>
...
export default {
  ...
  methods: {
    ...
    async loadLawDetail() {
      try {
        ...
        this.form = {
          ...
          law_desc: law.law_desc,
          category_id: law.category_id,
          related_action_id: law.related_action_id || null,
          applicable_scenes: law.applicable_scenes || ''
        }
      } catch (e) {
    ...
    async submit() {
      ...
      try {
        await api.laws.update(this.lawId, {
